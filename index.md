...
Scripts 01 and 02 (data loading and cleaning) process energy access survey data held by a government partner and are maintained in a separate private repository — see the [full README](https://github.com/varshabsuresh/energy-climate-nexus#what-is-not-included) for details on what's included and what isn't.
